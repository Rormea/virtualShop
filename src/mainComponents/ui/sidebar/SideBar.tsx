...
export const SideBar = () => {
    ...
    const sideMenuIsOpen = useUIStore(state => state.isSideMenuOpen);
    ...
    return (
        <div className=''>
            ...
            <nav
                className={
                    clsx(
                        'fixed p-5 right-0 top-0 w-[400px] h-screen bg-slate-200 z-20 shadow-2xl transform transition-all duration-300',
                        {
                            "translate-x-full": !sideMenuIsOpen
                        }
                    )
                }
            >
                ...
                {/* Menu*/}
                <Link href='/' className='flex items-center mt-10 p-2  hover:bg-gray-300 rounded transition-all'>
